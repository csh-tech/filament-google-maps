...
export default function filamentGoogleMapsField(
    ...
    return {
        ...
        async createMap() {
            ...
            if (controls.searchBoxControl) {
                ...
                searchBox.addListener("places_changed", () => {
                    input.value = "";
                    markerLocation = searchBox.getPlaces()[0].geometry.location;
                });
            }
            ...
            if (!placeFields.includes(placeField)) {
                placeFields.push(placeField);
            }
            ...
            if (autocomplete) {
                ...
                if (geoComplete) {
                    ...
                    gAutocomplete.addListener("place_changed", () => {
                        ...
                        markerLocation = place.geometry.location;
        ...
        markerMoved: function (event) {
            ...
            markerLocation = event.latLng.toJSON();
            this.setCoordinates(markerLocation);
            this.updateFromLocation(markerLocation);
        ...
        geoJsonContains: function (latLng) {
            if (geoJson && geoJsonField) {
                ...
                geoJsonDataLayer.forEach((feature) => {
